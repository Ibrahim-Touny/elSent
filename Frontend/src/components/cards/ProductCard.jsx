      ...
      <div className="bg-white shadow-s1 rounded-xl p-3">
        <div className="h-56 relative overflow-hidden">
          ...
          <ProfileCard className="shadow-s1 absolute right-3 bottom-3">
            <RiAuctionFill size={22} className="text-primary" />
          </ProfileCard>
          ...
          <div className="absolute top-0 left-0 p-2 w-full">
            <div className="flex items-center justify-between">
              {item?.isSoldout ? (
                ...
                <Caption className="text-primary bg-primary/20 px-3 py-1 text-sm rounded-full">On Stock</Caption>
              )}
              <Caption className="text-primary bg-primary/20 px-3 py-1 text-sm rounded-full">{item?.totalBids} Bids</Caption>
            </div>
          </div>
        </div>
        <div className="details mt-4">
          <Title className="uppercase text-secondary">{item.title}</Title>
          <hr className="mt-3" />
          <div className="flex items-center justify-between py-4">
            <div className="flex items-center justify-between gap-5">
              <div>
                <RiAuctionFill size={40} className="text-primary" />
              </div>
              <div>
                <Caption className="text-primary">Current Bid</Caption>
